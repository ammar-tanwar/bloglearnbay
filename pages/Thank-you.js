  ...
  return (
    <div className={styles.main}>
      ...
      <div className={styles.rights}>
          ...
          <button className={styles.Button}>
                  <AiOutlineDownload className="bIcons" />
                  <a href="https://brochureslearnbay.s3.ap-south-1.amazonaws.com/New+Brochure/Full+Stack+Web+Development+Program+(1).pdf" target="_blank" >
                    Download Brochure
                  </a>
                </button>
          </div>
          ...
          <button className={styles.Button}>
                  <AiOutlineDownload className="bIcons" /> 
                  <a href="https://brochureslearnbay.s3.ap-south-1.amazonaws.com/New+Brochure/Advanced+Software+Development+Program.pdf" target="_blank" >
                    Download Brochure
                  </a>
                </button>
          </div>

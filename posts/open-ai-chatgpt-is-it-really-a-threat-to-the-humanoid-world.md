...
slug: home
headerAlt: "A banner image titled, 'OpenAI ChatGPT. Is it really a threat to the Humanoid world' shows a robot working with a laptop."
...
It comes with its array of limitations which can be seen below.
        ...
        ●      First, as the program’s answers are based on its research from various online sources, it can be biased toward the most supported data. The information on the internet can be biased, manipulated, and incorrect. Since the model does not have ethics instilled, it needs to possess the ability to know what is right or wrong.
         ...
         ●      It may offer answers that might be harmful in certain situations. Such as providing the wrong medication for a symptom by searching online. Here the information may differ for the most accurate result (which might be least circulated across the internet).
